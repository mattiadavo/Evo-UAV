...
from evolutionary import EvolutionaryGenerator
...
if __name__ == "__main__":
    ...
    try:
        args = arg_parse()
        generator = EvolutionaryGenerator(args.test, use_anchors=True)
